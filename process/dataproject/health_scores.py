...
# 1. 读取数据
df = pd.read_csv(os.path.join(script_dir, "data", "data3.0.csv"), encoding='utf-8-sig')
...
with open(os.path.join(static_dir, "dataset", "health_scores.json"),'w', encoding='utf-8') as f:
